...
$txt['lp_show_comment_block_set']              = array('none' => 'Нет', 'default' => 'Встроенный (по умолчанию)');
...
$txt['lp_use_block_icons_set']                 = array('none' => 'Нет', 'fontawesome' => 'Font Awesome (по умолчанию)');
