...
return [
	...
	'hide_calendar_in_menu_subtext' => 'You need to enable <a class="bbc_link" href="%s">Calendar</a> to make this block work properly. But if you do not want to see it in the menu, you can hide it.',
	'type' => 'What to display',
	'type_set' => ['Birthdays', 'Holidays', 'Events', 'Calendar'],
	...
	'and_more' => ' and more ',
	'birthdays_set' => '{count, plural, one {# birthday man} other {# birthday men}}',
