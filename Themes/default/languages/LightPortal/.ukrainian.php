...
// Profile
$txt['lp_show_own_blocks'] = 'Відображення індивідуальних блоків';
$txt['lp_show_own_blocks_set'] = array('Разом зі створеними адміністратором', 'Замість створених адміністратором');
