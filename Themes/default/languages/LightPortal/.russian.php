...
$txt['lp_standalone_mode_subtext']                  = 'Будет отключено всё, кроме страниц портала и игнорируемых областей.';
...
$txt['lp_show_debug_info']                          = 'Отображать время загрузки и количество запросов к таблицам портала';
