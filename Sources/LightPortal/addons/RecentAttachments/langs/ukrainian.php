...
$txt['lp_block_types']['recent_attachments']              = 'Останні вкладення';
$txt['lp_block_types_descriptions']['recent_attachments'] = 'Показує список останніх вкладень, доступних користувачеві.';

$txt['lp_recent_attachments_addon_num_attachments']    = 'Кількість вкладень для відображення';
