...
$txt['lp_frontpage_mode_set']                = array(
	...
	'all_pages'     => 'Всі активні сторінки порталу',
...
$txt['lp_fontawesome_compat_themes']      = 'Позначте теми, які використовують іконки Font Awesome';
...
$txt['lp_page_keywords_enter_to_add'] = 'Натисніть <strong>Enter</strong> чи <strong>TAB</strong> для додавання:';
