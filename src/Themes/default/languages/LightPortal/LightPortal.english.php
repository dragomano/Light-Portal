...
$txt['lp_list_view'] = 'List view';
$txt['lp_card_view'] = 'Card view';
...
$txt['lp_promote_to_fp'] = 'Promote to the front page';
$txt['lp_remove_from_fp'] = 'Remove from the front page';
...
$txt['lp_frontpage_chosen_page'] = 'Portal page to display as the main page';
$txt['lp_frontpage_categories'] = 'Categories - sources of articles for the front page';
$txt['lp_frontpage_categories_select'] = 'Select the desired categories';
$txt['lp_frontpage_boards'] = 'Boards - sources of articles for the front page';
$txt['lp_frontpage_boards_select'] = 'Select the desired boards';
$txt['lp_frontpage_pages'] = 'Pages - sources of articles for the front page';
...
$txt['lp_comment_block'] = 'Show page comments';
$txt['lp_comment_block_set'] = ['None', 'Integrated'];
...
$txt['lp_menu_separate_subsection'] = 'Separate subsection in the menu for selected pages';
$txt['lp_menu_separate_subsection_help'] = 'To add pages to this subsection, enable the appropriate option in the settings of the desired pages under the "Access and placement" tab.';
$txt['lp_menu_separate_subsection_title'] = 'Name of subsection';
$txt['lp_menu_separate_subsection_title_help'] = 'Both plain text and translatable tokens can be used. For example, {0}. Then the {1} variable from the language files will be used.';
$txt['lp_menu_separate_subsection_href'] = 'Menu item link';
...
$txt['lp_panels_info'] = 'Here, you can customize the width of certain panels and adjust the direction of the blocks.<br><strong>{0}</strong> uses <a class="bbc_link" href="{1}" target="_blank" rel="noopener">12 column grid system</a> to display blocks in 6 panels.';
...
$txt['lp_panel_layout_preview'] = 'You can set the number of columns for certain panels here, depending on the width of the browser window. The grid system divides the screen into 12 columns and you can mention how much width can be taken for components in mobile devices, tablets and desktops. The breakpoints for xs, sm, md, lg and xl are 576px, 768px, 992px and 1200px. You can see the difference by resizing the browser window of the page.';
...
$txt['lp_blocks_manage_description'] = 'All created portal blocks are listed here. To add a block, click the "+" button.';
...
$txt['lp_blocks_add_instruction'] = 'Select the desired block by clicking on it. If the block you need is not in the list, check if the <a class="bbc_link" href="%s">corresponding plugin</a> is enabled.';
...
$txt['lp_pages_manage_description'] = 'Use the appropriate button to add a new page.';
...
$txt['lp_categories_add_description'] = 'Usually tags are enough, but some people like to categorize all things.';
...
$txt['lp_plugins_types']['frontpage'] = 'The layout of the front page';
...
// Who
$txt['lp_who_viewing_frontpage'] = 'Viewing <a href="%s">the portal front page</a>.';
