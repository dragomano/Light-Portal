...
$txt['lp_frontpage_card_alt_layout_help'] = 'Дата и автор меняются местами.';
...
$txt['lp_frontpage_article_sorting_set']  = array('По последнему комментарию', 'По дате создания (новые вверху)', 'По дате создания (старые вверху)');
...
$txt['lp_teaser_size_help']               = 'Используется в некоторых аддонах, а также может использоваться в пользовательских макетах главной страницы.';
...
$txt['lp_plugins_info'] = 'Здесь перечислены установленные плагины портала. Вы всегда можете создать новый, воспользовавшись <a class="bbc_link" href="%1$s" target="_blank" rel="noopener">инструкцией</a>.<br>Спонсорам портала доступно несколько <a href="%2$s" target="_blank" rel="noopener">эксклюзивных плагинов</a>.';
...
$txt['lp_pages_manage_tab_description'] = 'Для добавления новой страницы воспользуйтесь соответствующей кнопкой.';
