...
$txt['permissionhelp_light_portal_moderate_pages'] = 'Ability to manage any pages. The <strong>Page Moderator</strong> has access to all portal pages via the menu <em>Moderate - Manage pages</em>.';
