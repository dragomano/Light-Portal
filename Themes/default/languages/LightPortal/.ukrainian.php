...
$txt['lp_frontpage_mode_set'] = array(
	...
	'all_pages'     => 'Всі сторінки з обраних рубрик',
	'chosen_pages'  => 'Вибрані сторінки',
	'all_topics'    => 'Всі теми з обраних розділів',
	'chosen_topics' => 'Вибрані теми',
	'chosen_boards' => 'Вибрані розділи'
);
...
$txt['lp_show_teaser']                       = 'Відображати короткий зміст (тизер) статей';
...
$txt['lp_fontawesome_compat_themes']      = 'Відзначте теми, в яких не відображаються іконки дій';
$txt['lp_fontawesome_compat_themes_help'] = 'При включенні цієї опції замість стандартних іконок будуть використовуватися іконки Font Awesome.';
