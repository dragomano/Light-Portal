...
class Plugin extends PortalEntity {
  ...
  showSettings(target) {
    ...
    el.style.display =
      el.ownerDocument.defaultView.getComputedStyle(el, null).display === 'none' ? 'block' : 'none';
  }
  ...
  toggleToListView(el) {
    ...
    el.style.opacity = 1;
    el.nextElementSibling.style.opacity = 0.5;
  }
  ...
  toggleToCardView(el) {
    ...
    el.style.opacity = 1;
    el.previousElementSibling.style.opacity = 0.5;
  }
