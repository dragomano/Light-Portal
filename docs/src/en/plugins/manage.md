...
The separate plugin package can be installed in the Plugin Import section. But you can also just extract the plugin folder from the downloaded archive and move it to the directory `Sources/LightPortal/Plugins`.
