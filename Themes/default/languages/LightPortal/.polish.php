...
$txt['lp_frontpage_mode_set'] = array('Wyłącz', 'Wybrana strona', 'All pages from selected categories', 'Selected pages', 'Wszystkie wątki z wybranych działów', 'Selected topics', 'Wybrane działy');
...
$txt['lp_plugins_types'] = array(
	'Blok', 'Edytor', 'Widget komentarzy', 'Parser zawartości', 'Przetwarzanie artykułów', 'The layout of the frontpage', 'Import and export', 'Inne', 'Block options', 'Page options'
);
...
// Time units
$txt['lp_days_set'] = 'dzień, dni';
$txt['lp_hours_set'] = 'godzina, godzin';
$txt['lp_minutes_set'] = 'minuta, minut';
$txt['lp_seconds_set'] = 'sekunda, sekund';
...
// Social units
$txt['lp_posts_set'] = 'wiadomość, wiadomości';
$txt['lp_replies_set'] = 'odpowiedź, odpowiedzi';
$txt['lp_views_set'] = 'wyświetleń, wyświetlenia';
$txt['lp_comments_set'] = 'komentarz, komentarze, komentarzy';
$txt['lp_articles_set'] = 'artykuł, artykuły, artykułów';

// Other units
$txt['lp_users_set'] = 'użytkownik, użytkowników';
$txt['lp_guests_set'] = 'gość, gości';
$txt['lp_spiders_set'] = 'bot, botów';
$txt['lp_hidden_set'] = 'ukryty, ukrytych';
$txt['lp_buddies_set'] = 'znajomy, znajomych';
