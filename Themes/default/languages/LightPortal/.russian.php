...
$txt['lp_base_info'] = 'Версия мода: <strong>%1$s</strong>, версия PHP: <strong>%2$s</strong>, версия %3$s: <strong>%4$s</strong>.<br>Обсудить на русском баги и фичи портала можно на <a class="bbc_link" href="https://dragomano.ru/forum/index.php?board=4.0">форуме разработчика</a>.<br>Вы также можете <a class="bbc_link" href="https://ko-fi.com/U7U41XD2G">купить разработчику чашку кофе</a> или пожертвовать любую сумму на <a class="bbc_link" href="https://qiwi.com/n/DRAGOMANO">QIWI Кошелёк</a>.<br>Порталу всегда нужны новые тестеры, переводчики и создатели шаблонов главной страницы.';
$txt['lp_debug_info'] = 'Информация для отладки';

$txt['lp_frontpage_title'] = 'Заголовок главной страницы';
$txt['lp_frontpage_mode'] = 'Первая страница портала';
$txt['lp_frontpage_mode_set'] = array('Отключить', 'Указанная страница', 'Все страницы из выбранных рубрик', 'Выбранные страницы', 'Все темы из выбранных разделов', 'Выбранные темы', 'Выбранные разделы');
...
$txt['lp_show_teaser'] = 'Отображать краткое содержание статей';
...
$txt['lp_frontpage_layout'] = 'Шаблон оформления карточек статей';
$txt['lp_frontpage_num_columns'] = 'Количество колонок для вывода статей';
$txt['lp_frontpage_num_columns_set'] = array('1 колонка', '2 колонки', '3 колонки', '4 колонки', '6 колонок');
$txt['lp_show_pagination'] = 'Отображать пагинацию';
$txt['lp_show_pagination_set'] = array('Только внизу', 'Вверху и внизу', 'Только вверху');
$txt['lp_use_simple_pagination'] = 'Использовать упрощенную пагинацию';
...
$txt['lp_portal_action'] = 'Значение параметра <strong>action</strong> портала';
$txt['lp_page_param'] = 'Параметр <strong>page</strong> для страниц портала';
...
$txt['lp_action_toggle'] = 'Переключить статус';
...
$txt['lp_page_types'] = array('ББ-код', 'HTML', 'PHP');
...
$txt['lp_page_options'] = array('Показывать автора и дату создания', 'Показывать похожие страницы', 'Разрешить комментарии');
...
$txt['lp_import_success'] = 'Импортировано %1$s';
...
$txt['lp_plugins_types'] = array(
	'Блок', 'Редактор', 'Виджет комментариев', 'Парсер контента', 'Обработка статей', 'Макет главной страницы', 'Импорт и экспорт', 'Разное', 'Параметры блоков', 'Параметры страниц'
);
$txt['lp_plugins_requires'] = 'Требуемые плагины';
$txt['lp_plugins_disables'] = 'Конфликтные плагины';
...
$txt['lp_block_not_editable'] = 'Вам запрещено редактирование этого блока!';
...
$txt['lp_addon_requires_ssi'] = 'Плагин %1$s зависит от SSI.php, который должен находиться в корне форума!';
...
// Time units
$txt['lp_days_set'] = 'день, дня, дней';
$txt['lp_hours_set'] = 'час, часа, часов';
$txt['lp_minutes_set'] = 'минуту, минуты, минут';
...
// Social units
$txt['lp_posts_set'] = 'сообщение, сообщения, сообщений';
$txt['lp_replies_set'] = 'ответ, ответа, ответов';
$txt['lp_views_set'] = 'просмотр, просмотра, просмотров';
$txt['lp_comments_set'] = 'комментарий, комментария, комментариев';
$txt['lp_articles_set'] = 'статья, статьи, статей';

// Other units
$txt['lp_pages_set'] = 'страница, страницы, страниц';
$txt['lp_blocks_set'] = 'блок, блока, блоков';
$txt['lp_users_set'] = 'пользователь, пользователя, пользователей';
$txt['lp_guests_set'] = 'гость, гостя, гостей';
...
$txt['lp_translators'] = 'Переводчики';
$txt['lp_testers'] = 'Тестеры';
$txt['lp_sponsors'] = 'Спонсоры';
