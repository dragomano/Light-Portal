...
$txt['lp_frontpage_mode_set'] = array(
	'Désactivée',
	'chosen_page'   => 'Page spécifiée',
	'all_pages'     => 'Toutes les pages des catégories sélectionnées',
	'chosen_pages'  => 'Pages sélectionnées',
	'all_topics'    => 'Tous les sujets des tableaux sélectionnés',
	'chosen_topics' => 'Sujets sélectionnés',
	'chosen_boards' => 'Sections sélectionnées'
);
...
$txt['lp_frontpage_topics']                  = 'Sujetss - sources d\'articles pour la page d\'accueil';
...
$txt['lp_frontpage_custom_time_format_help'] = 'Voir la liste des paramètres possibles dans le <a class="bbc_link" href="https://www.php.net/manual/en/datetime.format.php">documentation</a>.';
$txt['lp_show_teaser']                       = 'Afficher un extrait de l\'article';
$txt['lp_teaser_size']                       = 'La taille maximale des extraits d\'article (en symboles)';
...
$txt['lp_frontpage_layout']                  = 'Nombre de colonnes d\'affichage des articles';
$txt['lp_frontpage_layout_set']              = array("1 colonne", "2 colonnes", "3 colonnes", "4 colonnes", "6 colonnes");
...
$txt['lp_standalone_mode_disabled_actions_help']    =  'Par exemple, si vous devez désactiver la zone de recherche (index.php?action=<strong>recherche</strong>), ajouter <strong>search</strong> dans le champ de texte.';
...
$txt['lp_show_comment_block_set']           = array('rien' => 'Rien', 'défaut' => 'Intégré');
...
$txt['lp_fontawesome_compat_themes']      = 'Vérifiez les thèmes qui utilisent les icônes Font Awesome';
$txt['lp_fontawesome_compat_themes_help'] = 'Option de compatibilité pour les modèles utilisant les icônes Font Awesome.';
...
$txt['lp_block_types'] = array(
	'bbc'  => 'BBC personnalisée',
	'html' => 'HTML personnalisé',
	'php'  => 'PHP personnalisé'
);
$txt['lp_block_types_descriptions'] = array(
	'bbc'  => 'Dans ce bloc, toutes les balises BBC du forum peuvent être utilisées comme contenu.',
	'html' => 'Dans ce bloc, vous pouvez utiliser n\'importe quelle balise HTML comme contenu.',
	'php'  => 'Dans ce bloc, vous pouvez utiliser n\'importe quel code PHP comme contenu.'
);
...
$txt['lp_page_options'] = array(
	'show_author_and_date' => 'Afficher l\'auteur et la date de création',
	'show_related_pages'   => 'Afficher les pages associées',
	'allow_comments'       => 'Autoriser les commentaires',
	'main_menu_item'       => 'Élément dans le menu principal'
);
...
$txt['lp_plugins_hooks_types'] = array(
	'bloc'     => 'Bloc',
	'éditeur'    => 'Editeur',
	'commentaire'   => 'Widget des commenatires',
	'analyseur'    => 'Analyseur de contenu',
	'article'   => 'Gestion des articles',
	'accueil' => 'La mise en page de la page d\'accueil',
	'impex'     => 'Importer et exporter',
	'autre'     => 'Autre'
);
...
$txt['lp_plugin_option_types'] = array(
	...
	'int'        => 'Chosir un nombre',
	'chocher'      => 'Case à cocher',
	'multicheck' => 'Sélection multiple',
	'sélection'     => 'Sélection'
);
...
// Time units
$txt['lp_days_set']       = array('jour','jours');
$txt['lp_hours_set']      = array('heure','heures');
$txt['lp_minutes_set']    = array('minute','minutes');
$txt['lp_seconds_set']    = array('seconde','secondes');
...
// Social units
$txt['lp_posts_set']    = array('message', 'messages');
$txt['lp_replies_set']  = array('réponse', 'réponses');
$txt['lp_views_set']    = array('vue', 'vues');
$txt['lp_comments_set'] = array('commentaire', 'commentaires');

// Other units
$txt['lp_users_set']   = array('utilisateur', 'utilisateurs');
$txt['lp_guests_set']  = array('invité', 'invités');
$txt['lp_spiders_set'] = array('robot', 'robots');
$txt['lp_hidden_set']  = array('caché', 'cachés');
$txt['lp_buddies_set'] = array('ami', 'amis');
