    ...
    plugins: [
      ...
      viteStaticCopy({
        targets: [
          ...
          { src: 'node_modules/stockfish/src/stockfish-18-lite-single.js', dest: resolve(dist, 'ChessBoard/stockfish') },
          { src: 'node_modules/stockfish/src/stockfish-18-lite-single.wasm', dest: resolve(dist, 'ChessBoard/stockfish') },
        ],
      }),
    ],
  });
