...
/**
 * .spanish latin language file Rev. 3
...
$txt['lp_php_mysql_info']                      = 'Versión del mod: <strong>%1$s</strong>, PHP versión: <strong>%2$s</strong>, %3$s versión: <strong>%4$s</strong>.';
...
$txt['lp_teaser_size']                         = 'El tamaño máximo de los avances de los artículos (en símbolos)';
$txt['lp_num_items_per_page']                  = 'Número de elementos por página (para paginación)';
$txt['lp_standalone']                          = 'Modo independiente';
$txt['lp_standalone_help']                     = 'Todo excepto las páginas del portal y las áreas ignoradas se desactivarán.';
$txt['lp_standalone_excluded_actions']         = 'Acciones ignoradas';
$txt['lp_standalone_excluded_actions_subtext'] = 'Especifique las áreas que deberían permanecer disponibles sin conexión.';
...
$txt['lp_show_comment_block_set']              = array('Ninguno', 'Predeterminado' => 'Integrado (por defecto)');
$txt['lp_num_comments_per_page']               = 'Número de comentarios por página'; // Check the meaning of "father"
...
$txt['lp_open_graph']                          = 'Open Graph'; // Review later
$txt['lp_page_og_image']                       = 'Usar una imagen del contenido de la página';
...
$txt['groups_light_portal_manage_blocks']      = '¿Quién puede administrar bloques?';
$txt['groups_light_portal_manage_own_pages']   = '¿Quién puede administrar sus propias páginas?';
$txt['lp_manage_blocks_warning']               = 'Nota: algunos bloques pueden contener contenido HTML/PHP peligroso, ¡así que no otorgue este derecho a todos!';
$txt['lp_manage_own_pages_warning']            = 'Nota: algunas páginas pueden contener contenido HTML/PHP peligroso, ¡así que no otorgue este derecho a todos!';
$txt['lp_extra_settings']                      = 'Ajustes extras';
...
$txt['lp_no_items']                     = 'Aún no hay nada. ¿Vamos a agregar?';
...
$txt['lp_who_viewing_the_tag']   = 'Viendo la lista de páginas con <a href="%1$s" class="bbc_link">%2$s</a> etiquetas.';
...
// Copyrights
$txt['lp_credits']         = 'Créditos';
$txt['lp_used_components'] = 'Los componentes del portal';

// Script execution time and memory usage
$txt['lp_load_page_stats'] = 'Cargado en %1$.3f segundos. Memoria usada: %2$d ' . $txt['megabyte'] . '.';
