<div x-data="handleImages()">
						...
						<tr class="windowbg">
							...
							<td style="display: flex; flex-direction: column; gap: 10px">
								...
								<input
									...
									name="image_link[]"
									required
									placeholder="{{ $txt['lp_tiny_slider']['link_placeholder'] }}"
								>
							</td>
						</tr>
						<tr class="windowbg">
							<td colspan="2">
								<input
									...
									name="image_title[]"
									maxlength="255"
									placeholder="{{ $txt['lp_tiny_slider']['title_placeholder'] }}"
								>
							</td>
						</tr>
						</tbody>
	...
	<button type="button" class="button floatnone" @click="addImage()">
		<span class="main_icons plus"></span> {{ $txt['lp_tiny_slider']['image_add'] }}
	</button>
</div>
