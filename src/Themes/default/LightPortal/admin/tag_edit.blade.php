...
@section('preview')
	@include('admin.partials._preview', [
		'show_preview' => isset($context['preview_title']),
		'preview_type' => 'title',
	])
@endsection

@section('form_data')
	x-data='{ title: @json($context['lp_tag']['title'], JSON_UNESCAPED_UNICODE) }'
@endsection
...
@push('buttons')
	@include('admin.partials._buttons', [
		'id'     => $context['lp_tag']['id'],
		'entity' => 'tag',
	])
@endpush

@push('script', 'const tag = new Tag();')
