...
function template_show_page(): void
{
	...
	<aside class="infobox">
		...
		<div>
			<a class="button floatright" href="', Config::$scripturl, '?action=admin;area=lp_pages;sa=edit;id=', Utils::$context['lp_page']['id'], '">', Utils::$context['lp_icon_set']['edit'], '<span class="hidden-xs">', Lang::$txt['edit'], '</span></a>';
		...
		if (! (empty(Utils::$context['user']['is_admin']) || empty(Config::$modSettings['lp_frontpage_mode']) || Config::$modSettings['lp_frontpage_mode'] !== 'chosen_pages')) {
			echo '
			<a class="button floatright" href="', Utils::$context['canonical_url'], ';promote">', Utils::$context['lp_icon_set']['home'], '<span class="hidden-xs hidden-sm">', Lang::$txt['lp_' . (in_array(Utils::$context['lp_page']['id'], Utils::$context['lp_frontpage_pages']) ? 'remove_from' : 'promote_to') . '_fp'], '</span></a>';
		}
		...
		if (! empty(Utils::$context['lp_page']['options']['show_author_and_date'])) {
			...
			<p>
				<span class="floatleft" itemprop="author" itemscope itemtype="https://schema.org/Person">
					', Utils::$context['lp_icon_set']['user'], '<span itemprop="name">', Utils::$context['lp_page']['author'], '</span>
				...
				<time class="floatright" datetime="', date('c', Utils::$context['lp_page']['created_at']), '" itemprop="datePublished">
					', Utils::$context['lp_icon_set']['date'], Utils::$context['lp_page']['created'], empty(Utils::$context['lp_page']['updated_at']) ? '' : (' / ' . Utils::$context['lp_page']['updated'] . ' <meta itemprop="dateModified" content="' . date('c', Utils::$context['lp_page']['updated_at']) . '">'), '
				</time>
			</p>';
		}
	...
	if (! empty(Utils::$context['lp_page']['tags']) && ! empty(Config::$modSettings['lp_show_tags_on_page'])) {
		...
		foreach (Utils::$context['lp_page']['tags'] as $tag) {
			echo '
				<a class="button" href="', $tag['href'], '">', Utils::$context['lp_icon_set']['tag'], $tag['name'], '</a>';
		}
...
function show_prev_next_links(): void
{
	...
	if (!empty(Utils::$context['lp_page']['prev']))
		echo '
		<a class="floatleft" href="', Utils::$context['lp_page']['prev']['link'], '">', Utils::$context['lp_icon_set']['arrow_left'], ' ', Utils::$context['lp_page']['prev']['title'], '</a>';

	if (!empty(Utils::$context['lp_page']['next']))
		echo '
		<a class="floatright" href="', Utils::$context['lp_page']['next']['link'], '">', Utils::$context['lp_page']['next']['title'], ' ', Utils::$context['lp_icon_set']['arrow_right'], '</a>';
