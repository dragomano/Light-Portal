...
function tiny_slider_images(array $options): string
{
	return /** @lang text */ '
	<div x-data="handleImages()">
								...
								<tbody>
									<tr class="windowbg">
										...
										<td style="display: flex; flex-direction: column; gap: 10px">
											...
											<input type="url" x-model="image.link" name="image_link[]" required placeholder="' . Lang::$txt['lp_tiny_slider']['link_placeholder'] . '">
										</td>
									</tr>
									<tr class="windowbg">
										<td colspan="2">
											<input type="text" x-model="image.title" name="image_title[]" maxlength="255" placeholder="' . Lang::$txt['lp_tiny_slider']['title_placeholder'] . '">
										</td>
									</tr>
								</tbody>
							</table>
		...
		<button type="button" class="button floatnone" @click="addImage()"><span class="main_icons plus"></span> ' . Lang::$txt['lp_tiny_slider']['image_add'] . '</button>
	</div>
