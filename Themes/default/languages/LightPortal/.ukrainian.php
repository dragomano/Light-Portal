...
$txt['lp_use_simple_pagination'] = 'Використовувати спрощену пагінацію';
...
$txt['groups_light_portal_manage_own_blocks'] = 'Хто може керувати своїми блоками';
...
$txt['lp_prohibit_php'] = 'Заборонити всім, крім адміністраторів, створення PHP-сторінок і PHP-блоків';
...
$txt['lp_portal_action'] = 'Значення параметра <strong>action</strong> порталу';
$txt['lp_page_param'] = 'Параметр <strong>page</strong> для сторінок порталу';
...
$txt['lp_block_select_icon'] = 'Виберіть іконку';
...
// Internal blocks
$txt['lp_bbc']['title'] = 'Блок з ББ-кодом';
$txt['lp_html']['title'] = 'Блок з HTML-кодом';
$txt['lp_php']['title'] = 'Блок з PHP-кодом';
$txt['lp_bbc']['description'] = 'У цьому блоці як контент можна використовувати будь-які ББ-теги форуму.';
$txt['lp_html']['description'] = 'У цьому блоці як контент можна використовувати будь-які теги HTML.';
$txt['lp_php']['description'] = 'У цьому блоці як контент можна використовувати довільний код PHP.';
...
$txt['lp_plugins_types'] = array(
	'Блок', 'Редактор', 'Віджет коментарів', 'Парсер контента', 'Обробка статей', 'Макет головної сторінки', 'Імпорт та експорт', 'Різне', 'Параметри блоків', 'Параметри сторінок'
);
$txt['lp_plugins_requires'] = 'Необхідні плагіни для роботи';
...
$txt['lp_block_not_editable'] = 'Вам заборонено редагування цього блоку!';
...
$txt['lp_addon_requires_ssi'] = 'Плагін %1$s залежить від SSI.php, який повинен знаходитися в корені форуму!';
...
$txt['permissionname_light_portal_manage_own_blocks'] = $txt['group_perms_name_light_portal_manage_own_blocks'] = 'Управління своїми блоками';
...
$txt['permissionhelp_light_portal_manage_own_blocks'] = 'Доступ до управління своїми блоками.';
...
$txt['cannot_light_portal_manage_own_blocks'] = 'Вибачте, вам заборонено керування блоками порталу!';
...
$txt['uninstall_lp_addon'] = 'Видалити аддон';
