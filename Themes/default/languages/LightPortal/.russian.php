...
$txt['lp_new_version_is_available']            = 'Доступна <a href="%1$s" target="_blank" rel="noopener">новая версия</a>!';
...
$txt['lp_frontpage_mode_set']                  = array('Главная страница портала', 'Все темы из выбранных разделов', 'Все страницы (кроме первой)', 'Разделы с описаниями');
...
$txt['lp_pages_add_tab_description']    = '<strong>Алиас</strong> страницы используется в адресной строке и может содержать только латинские символы и цифры!<br>У главной страницы алиас всегда равен "/".';
