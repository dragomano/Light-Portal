...
$txt['lp_menu_separate_subsection_help'] = 'To add pages to this subsection, enable the appropriate option in the settings of the desired pages, on the tab "Access and placement".';
...
$txt['lp_page_slug_subtext'] = 'The page slug must begin with a Latin letter and consist of lowercase Latin letters, numbers, dashes or underscores.';
