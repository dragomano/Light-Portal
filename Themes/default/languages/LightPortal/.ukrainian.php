...
$txt['lp_frontpage_article_sorting_set']  = array('За останнім коментарем', 'За датою створення (нові вгорі)', 'За датою створення (старі вгорі)');
...
$txt['lp_plugins_info'] = 'Тут перераховані встановлені плагіни порталу. Ви завжди можете створити новий, скориставшись <a class="bbc_link" href="%1$s" target="_blank" rel="noopener">інструкцією</a>.<br>Спонсорам порталу доступно кілька <a href="%2$s" target="_blank" rel="noopener">ексклюзивних плагінів</a>.';
