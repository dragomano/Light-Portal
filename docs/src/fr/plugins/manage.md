...
The separate plugin package can be installed in the Plugin Import section. Mais vous pouvez également simplement extraire le dossier du plugin de l'archive téléchargée et le déplacer dans le répertoire `Sources/LightPortal/Plugins`.
