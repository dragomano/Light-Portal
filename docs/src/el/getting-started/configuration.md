...
Σε αυτήν την ενότητα, μπορείτε να προσαρμόσετε πλήρως την αρχική σελίδα της πύλης, να ενεργοποιήσετε την αυτόνομη λειτουργία και να αλλάξετε τα δικαιώματα χρήστη για πρόσβαση στα στοιχεία της πύλης.

### Ρυθμίσεις για την πρώτη σελίδα και τα άρθρα

Για να αλλάξετε το περιεχόμενο της αρχικής σελίδας της πύλης, επιλέξτε την κατάλληλη λειτουργία "η αρχική σελίδα της πύλης":
