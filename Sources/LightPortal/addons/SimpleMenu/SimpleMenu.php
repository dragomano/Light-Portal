...
class SimpleMenu extends Plugin
{
	...
	public function validateBlockData(array &$parameters, string $type)
	{
		...
		$data = Helper::post()->only(['item_name', 'item_link']);
		...
		if (! empty($data) && ! empty($data['item_name']) && ! empty($data['item_link'])) {
			...
			Helper::post()->put('items', json_encode($items, JSON_UNESCAPED_UNICODE));
		}
	...
	public function prepareContent(string $type, int $block_id, int $cache_time, array $parameters)
	{
		...
		$simple_menu_html = Helper::cache('simple_menu_addon_b' . $block_id)
